...
class GameView3(var c: Context, var gameTask: GameTask) : View(c) {
    private var myPaint: Paint? = null
    private var speed3 = 4
    ...
    override fun onDraw(canvas: Canvas?) {
        ...
        canvas.drawText("Speed: $speed3", 380f, 80f, myPaint!!)
        invalidate()
    }
